	...
	return (
		...
		>
			<CardMedia
				...
				fill
				sizes='(min-width: 0px) 81.948vw, (min-width: 1024px) 25.558vw, (min-width: 1280px) 25.909vw, (min-width: 1536px) 26.144vw'
								...
								>
									<Box>
										<AdvancedImage
											...
											fallback={`https://placehold.co/24?text=Not+Found`}
